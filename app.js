...
mongoose.connect(`mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@atstestcluster-ipozf.mongodb.net/${process.env.MONGO_DB}?retryWrites=true&w=majority`)
        .then(() => {
